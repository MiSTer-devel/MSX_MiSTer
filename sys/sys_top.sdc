...
create_generated_clock -name clk10 -source [get_pins {emu|pll|pll_inst|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}] -divide_by 2 -duty_cycle 50 -phase 0 [get_nets {emu:emu|emsx_top:emsx|clkdiv[0]}]
create_generated_clock -name clk5  -source [get_pins {emu|pll|pll_inst|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}] -divide_by 4 -duty_cycle 50 -phase 0 [get_nets {emu:emu|emsx_top:emsx|clkdiv[1]}]
...
set_clock_groups -asynchronous \
   -group [get_clocks { *|pll|pll_inst|altera_pll_i|general[*].gpll~PLL_OUTPUT_COUNTER|divclk clk10 clk5}] \
