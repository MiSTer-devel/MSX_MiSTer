...
### Notes about SD card:
* Core does not require a secondary SD card located on I/O Board v5.x. You can use an VHD images on the main SD card.
* You can use SD card of any size, but only partitions less than 4GB are supported. It's advised to use sdcreate utility. It will create 4GB partition if the SD card is bigger than 4GB. 
